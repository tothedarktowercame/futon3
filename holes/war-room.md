...
| [9](war-bulletin-9.md) | 2026-05-17 | The Stack Authors Its Own Pilot | Outward-facing operational layer (M-interim-director + M-interest-network-coupling); UKRN-S v12 as predecessor-exemplar ported inward; AIF substrate now a *family* across 5 scopes; HEAD-as-escrow sanctioned; futon0-cyborg / futon7-Markov-blanket load-bearing; mark2 + apm-lean as first-class observation channels; WR-11–WR-17 |
